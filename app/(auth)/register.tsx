...
export default function RegisterScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      else if (!error.response) setGlobalError('Impossible de joindre le serveur. Vérifiez votre connexion internet.');
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.formCard}>
          {globalError ? (
            <View style={styles.errorAlert} accessible accessibilityRole="alert" accessibilityLiveRegion="assertive">
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.first_name ? <Text style={styles.fieldError}>{errors.first_name[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.last_name ? <Text style={styles.fieldError}>{errors.last_name[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.email ? <Text style={styles.fieldError}>{errors.email[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.password ? <Text style={styles.fieldError}>{errors.password[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.password_confirmation ? <Text style={styles.fieldError}>{errors.password_confirmation[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.birthdate ? <Text style={styles.fieldError}>{errors.birthdate[0]}</Text> : null}
          </View>

          <View style={styles.fieldContainer}>
            <Text style={styles.label}>Genre</Text>
            <View style={[styles.pickerBox, errors.gender && styles.inputError]}>
              <Picker selectedValue={formData.gender} onValueChange={(val) => handleChange('gender', String(val))} enabled={!loading}>
                <Picker.Item label="Homme" value="Homme" />
                <Picker.Item label="Femme" value="Femme" />
                <Picker.Item label="Autres" value="Autres" />
              </Picker>
            </View>
            {errors.gender ? <Text style={styles.fieldError}>{errors.gender[0]}</Text> : null}
          </View>
          ...
          <View style={styles.rowContainer}>
            <View style={[styles.fieldContainer, { flex: 1, marginRight: 8 }]}>
              ...
              {errors.height ? <Text style={styles.fieldError}>{errors.height[0]}</Text> : null}
            </View>
            <View style={[styles.fieldContainer, { flex: 1 }]}>
              ...
              {errors.weight ? <Text style={styles.fieldError}>{errors.weight[0]}</Text> : null}
            </View>
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.body_fat_pct ? <Text style={styles.fieldError}>{errors.body_fat_pct[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            <View style={[styles.pickerBox, errors.physical_activity_level && styles.inputError]}>
              <Picker selectedValue={formData.physical_activity_level} onValueChange={(val) => handleChange('physical_activity_level', String(val))} enabled={!loading}>
            ...
            {errors.physical_activity_level ? <Text style={styles.fieldError}>{errors.physical_activity_level[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            <View style={[styles.pickerBox, errors.favorite_exercise_category && styles.inputError]}>
              <Picker selectedValue={formData.favorite_exercise_category} onValueChange={(val) => handleChange('favorite_exercise_category', String(val))} enabled={!loading}>
                <Picker.Item label="Cardio" value="Cardio" />
                <Picker.Item label="Poids du corps" value="Poids du corps" />
                <Picker.Item label="Musculation" value="Musculation" />
              </Picker>
            </View>
            {errors.favorite_exercise_category ? <Text style={styles.fieldError}>{errors.favorite_exercise_category[0]}</Text> : null}
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            {errors.daily_caloric_intake ? <Text style={styles.fieldError}>{errors.daily_caloric_intake[0]}</Text> : null}
          </View>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel={loading ? 'Inscription en cours' : 'Créer mon compte'}
          ...
          <View style={styles.loginContainer}>
            ...
            <TouchableOpacity onPress={() => router.push('/login')} accessible accessibilityRole="link">
